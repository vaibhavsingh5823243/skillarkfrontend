        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block ska-glass ska-carousel">
              <h3>AWS</h3>
              <p>This is a data science full stack live mentor led certification program along with
                full time one-year internship provided by iNeuron intelligence private limited, where you will learn all the stack required to work in data science, data analytics and big data industry including ML ops and cloud infrastructure and real time industry project and product development along with iNeuron.</p>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block ska-glass ska-carousel">
              <h3>Second Course label</h3>
              <p>Some representative placeholder content for the second Course.</p>
            </div>
          </div>
          <div className="carousel-item">
            <div style={{ width: '100vw' }}>
            ...
            <div className="carousel-caption d-none d-md-block ska-glass ska-carousel">
              <h3>Third Course label</h3>
              <p>Some representative placeholder content for the third Course.</p>
            </div>
          </div>
        </div>
